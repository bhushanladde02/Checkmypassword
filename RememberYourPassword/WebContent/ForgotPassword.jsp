...
function checkEmail() {
    ...
    var email = document.getElementById('forgotPasswordEmail');
...
{
	if(checkEmail()){
	var newUrl = '/RememberYourPassword/Login.do?method=forgotPassword';
						...
						<div class="wrapper">
							<div class="grid_4 alpha">
							  <form id="contact-form"> 
						    	<fieldset>
						    	<label><input type="text" id="forgotPasswordEmail" name="forgotPasswordEmail" value="Registered Email" onFocus="if(this.value=='Registered Email'){this.value=''}" onclick="javascript:messagepass()" onBlur="if(this.value==''){this.value='Registered Email'}"></label>	
						    	<label><a href="#" class="button1"  onclick="javascript:getPassword()" id="register">Get Password</a></label>
						      </fieldset>						      
						     </form><br/>
						     
							</div>
							<font style="color: red;" size="10" ><bean:write name="LoginForm" property="forgotPasswordErrorMessage"></bean:write></font>						
						</div>
					</div>
